...
import 'package:flutter_kakao_app/components/my_chat.dart';
...
class _ChatRoomScreenState extends State<ChatRoomScreen> {
      ...
      body: Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              Icon(FontAwesomeIcons.search, size: 20, color: Colors.black),
              SizedBox(width: 25),
              Icon(FontAwesomeIcons.bars, size: 20, color: Colors.black),
              SizedBox(width: 25),
            ],
          ),
          body: Column(
  ...
  void _handleSubmitted(text){
    ...
    setState(() {
      chats.add(
          MyChat(
              text: text, time: DateFormat("a K:m")
